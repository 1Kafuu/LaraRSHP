{{-- Modal Create --}}
<el-dialog>
  <dialog id="create-pemilik" aria-labelledby="dialog-title" class="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent">
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 transform transition-all duration-300 scale-95 opacity-0 hidden" id="modalContent">
        ...
        <form id="updateForm" method="POST">
            ...
            <div class="px-6 py-4 space-y-4">
                ...
                <div>
                    <label for="no_wa_update" class="block text-sm font-medium text-gray-700 mb-1">No Telepon</label>
                    <input 
                        type="tel" 
                        name="no_wa" 
                        id="no_wa_update" 
                ...
                <div>
                    <label for="alamat_update" class="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                    <input 
                        type="text" 
                        name="alamat" 
                        id="alamat_update" 
