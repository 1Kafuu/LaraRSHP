...
@push('page')
    '{{ $pageName ?? 'datakategori' }}'
@endpush

@section('path', 'Data Kategori')
@section('title', 'Data Kategori')

@section('content')
    <div class="container-fluid py-4">
        <h1 class="mb-4 text-xl font-bold text-gray-800">Welcome to Data Kategori</h1>

        <!-- Card Container -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <!-- Header -->
            <div class="flex justify-between items-center p-5 border-b border-gray-100">
                <h5 class="text-lg font-semibold text-gray-800 mb-0">Kategori List</h5>
                <button command="show-modal" commandfor="create-kategori"
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-1">
                                        <!-- Edit Button -->
                                        <button type="button" onclick="openEditModal({{ $row->idkategori }})"
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center text-gray-500 text-base">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-400 mt-1">Klik "Add Kategori" untuk menambahkan data baru.
                                        </p>
                                    </div>
                                </td>
                            </tr>
...
@push('scripts')
    <script>
        function openEditModal(kategoriId) {
            ...
            // Fetch user data
            fetch(`/getKategoribyId/${kategoriId}`)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    ...
                    form.action = `/updateKategori/${data.idkategori}`;
                })
                .catch(error => {
