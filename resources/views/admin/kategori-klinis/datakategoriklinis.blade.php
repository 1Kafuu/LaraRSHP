                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-1">
                                        ...
                                        <button
                                            type="button"
                                            onclick="editKategoriKlinis({{ $row->idkategori_klinis }})"
                                        ...
                                        <button
                                            type="button"
                                            onclick="deleteKategoriKlinis({{ $row->idkategori_klinis }})"
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center text-gray-500 text-base">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-400 mt-1">Klik "Add Kategori Klinis" untuk menambahkan data baru.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
