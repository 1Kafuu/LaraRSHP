...
@section('path', 'Data Role')

@section('title', 'Data Role')

@section('content')
    <div class="container-fluid py-4">
        <h1 class="mb-4 text-xl font-bold text-gray-800">Welcome to Data Role</h1>
        
        <!-- Card Container -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <!-- Header -->
            <div class="flex justify-between items-center p-5 border-b border-gray-100">
                <h5 class="text-lg font-semibold text-gray-800 mb-0">Role List</h5>
                <button command="show-modal" commandfor="create-role"
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-1">
                                        <!-- Edit Button -->
                                        <button type="button" onclick="openEditModal({{ $row->idrole }})"
                                        ...
                                        <!-- Delete Button -->
                                        <form action="{{ route('deleteRole', ['id' => $row->idrole]) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
