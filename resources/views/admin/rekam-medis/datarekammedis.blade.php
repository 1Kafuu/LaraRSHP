                ...
                <table class="w-full table-auto">
                    ...
                    <thead class="bg-gray-50 text-indigo-700 font-semibold text-xs uppercase tracking-wider">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left">Anamnesa</th>
                            <th class="px-6 py-3 text-left">Temuan Klinis</th>
                            <th class="px-6 py-3 text-left">Diagnosa</th>
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-1">
                                        <button type="button" onclick="openDetailModal({{ $row->idrekam_medis }})"
                                            class="w-8 h-8 rounded-full border border-green-600 text-green-600 hover:bg-green-600 hover:text-white transition-all duration-200 flex items-center justify-center"
                                            title="Lihat Detail">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <!-- Edit Button -->
                                        <button type="button" onclick="openEditModal({{ $row->idrekam_medis }})"
