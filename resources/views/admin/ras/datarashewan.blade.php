    ...
    <div class="container-fluid py-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="flex justify-between items-center p-5 border-b border-gray-100">
                ...
                <button command="show-modal" commandfor="create-ras"
                        ...
                        @forelse ($groupRas as $index => $row)
                                    ...
                                    @foreach ($row['ras_hewan'] as $rasIndex => $ras)
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex justify-end items-center gap-1">
                                                <!-- Edit Button -->
                                                <button type="button" onclick="openEditModal({{ $ras['idras_hewan'] }})"
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('deleteRas', ['id' => $ras['idras_hewan']]) }}" method="POST"
                                                    class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                            ...
                            @else
                                ...
                                <tr class="hover:bg-indigo-50/30 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-block px-3 py-1 text-xs font-medium text-gray-500 bg-gray-100 rounded-full italic">
                                            Tidak ada ras
                                        </span>
                                    </td>
                                </tr>
        ...
        function openEditModal(rasId) {
            ...
            fetch(`/getRasbyId/${rasId}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('nama_update').value = data.nama_ras;

                    // Update form action
                    const form = document.getElementById('updateForm');
                    form.action = `/updateRas/${data.idras_hewan}`;
                })
                .catch(error => {
